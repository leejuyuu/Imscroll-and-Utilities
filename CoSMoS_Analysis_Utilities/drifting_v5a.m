function pc=drifting_v5a(gfolder,frmrange,frmlim,averange,fitwidth,filesource)
%
% function drifting_v5a(gfolder,frmrange,frmlim,averange,fitwidth,filesource)
%
...
pc=[];
mask=gaussian_spot(1,30,[0 0],1,50); % Make mask to zero frames at edges v5a
