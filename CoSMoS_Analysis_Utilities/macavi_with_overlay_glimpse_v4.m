function pc=macavi_with_overlay_glimpse_v4(gfolder,frames,dispscale,flagg,frmrate,avifolder,frmave,info,driftlist,aoiinfo2a, aoiinfo2b,varargin)
%
% function macavi_with_overlay_glimpse_v4(gfolder,frames,dispscale,flagg,frmrate,avifolder,frmave,info,driftlist,aoiinfo2a,aoiinfo2b,<frmlim>)
%
...
%      also added capability of drawing two diff color boxes, aoiinfo2a, aoiinfo2b
