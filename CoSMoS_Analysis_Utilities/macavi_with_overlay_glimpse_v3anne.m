function pc=macavi_with_overlay_glimpse_v3anne(gfolder,frames,dispscale,flagg,frmrate,avifolder,frmave,varargin)
%
% function macavi_with_overlay_glimpse_v3anne(imfold,frames,dispscale,flagg,frmrate,avifolder,frmave,<frmlim>)
%
...
% Comment out for anne   draw_aoifits_aois_no_numbers(info,'r');  % [0 .9 0] is green 
