function pc=ixon_read_newtiff(folder,range,rot90_arg,base_filename)
%
%function ixon_read_newtiff(folder,range,rot90_arg,[base_filename])
%
...
% stacked array as uint16 numbers.
%
% folder == e.g. 'p:\image_data\august_08_05\b11p73d\'.  The actual files
...
eval(['!copy ' folder ' d:\temp']);                 % copy all files to local disk
localfold='d:\temp\';
