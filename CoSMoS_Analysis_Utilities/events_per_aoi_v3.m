function pc=events_per_aoi_v3(cia,frmhilow,maxevents,EventRestrict,varargin)
%
% function events_per_aoi_v3(cia,frmhilow,maxevents,EventRestrict,<AOIRestrict>)
%
