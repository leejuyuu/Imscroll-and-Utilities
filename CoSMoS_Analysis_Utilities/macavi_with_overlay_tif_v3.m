function pc=macavi_with_overlay_tif_v3(gfolder,frames,dispscale,flagg,frmrate,avifolder,frmave,info,varargin)
%
% function macavi_with_overlay_tif_v3(imfold,frames,dispscale,flagg,frmrate,avifolder,frmave,info,<frmlim>)
%
...
%        dum(:,:,rdindx-inum+1)=imread(imfold,'tif',rdindx);
        ...
        dum(:,:,rdindx-inum+1)=imread(gfolder,'tif',rdindx);
