function pc=plot_spot_number(fp,frames,thresholds,NdSd,roi,aoiRadius,SequenceLength,ProbZ,fignum)
%
% function   plot_spot_number(fp,frames,thresholds,NdSd,roi,aoiRadius,SequenceLength,Probz,fignum)
%
...
frmnum=length(frames);          % The number of different frames in which
                                % we detect spots
spots=spot_numbers( fp,  frames,  thresholds,  NdSd, roi );
