function pc=drifting_v4(gfolder,frmrange,frmlim,averange,fitwidth,filesource)
%
% function drifting_v4(gfolder,frmrange,frmlim,averange,fitwidth,filesource)
%
...
center_peak_rose=Irose;
    ...
    outarg=gauss2dfit(double(fitregion_norm),double(inputarg0));
      ...
      outargxy=gauss2dxyfit(double(fitregion_norm),double([1 fitwidth/2 fitwidth/4  fitwidth/2 fitwidth/4 mn]) );
%keyboard
    ...
    latest_peak_rose=outarg(3)+ylow;
