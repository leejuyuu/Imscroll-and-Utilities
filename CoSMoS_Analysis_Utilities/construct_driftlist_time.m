function pc=construct_driftlist_time(xy_cell,vid,CorrectionRange,SequenceLength,Polyorderxy)
%
% function    construct_driftlist_time(xy_cell, vid, CorrectionRange, SequenceLength, Polyorderxy)
%
