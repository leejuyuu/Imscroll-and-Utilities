...
function testBpass(testCase)
    ...
    filteredImage = bpass(testImage, 1, 5);    
    filteredImageTrue = load('imscroll/test/test_data/test_bpass.mat').filteredImage;
    verifyEqual(testCase, filteredImage, filteredImageTrue)
end